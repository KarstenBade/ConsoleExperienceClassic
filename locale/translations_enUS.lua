...
ConsoleExperience_translation["enUS"] = {
    ...
    ["Manage action bars via profiles"] = "Manage action bars via profiles",
    ["When enabled, the addon manages action bar assignments via profiles and automatically preserves your original action bar layout by restoring it on logout. When disabled, the addon does not modify action bar assignments."] = "When enabled, the addon manages action bar assignments via profiles and automatically preserves your original action bar layout by restoring it on logout. When disabled, the addon does not modify action bar assignments.",
