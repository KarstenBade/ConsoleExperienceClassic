...
ConsoleExperience_translation["enUS"] = {
    ...
    ["When enabled, the addon saves and loads action bar assignments as part of profiles. When disabled, your server-side action bar assignments are left untouched."] = "When enabled, the addon saves and loads action bar assignments as part of profiles. When disabled, your server-side action bar assignments are left untouched.",
