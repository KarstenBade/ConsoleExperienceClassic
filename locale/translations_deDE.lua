...
ConsoleExperience_translation["deDE"] = {
    ...
    ["Manage action bars via profiles"] = "Aktionsleisten über Profile verwalten",
    ["When enabled, the addon manages action bar assignments via profiles and automatically preserves your original action bar layout by restoring it on logout. When disabled, the addon does not modify action bar assignments."] = "Wenn aktiviert, verwaltet das Addon die Aktionsleisten-Belegung über Profile und stellt beim Ausloggen automatisch die ursprüngliche Aktionsleisten-Belegung wieder her. Wenn deaktiviert, verändert das Addon die Aktionsleisten-Belegung nicht.",
