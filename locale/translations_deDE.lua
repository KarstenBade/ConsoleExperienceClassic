...
ConsoleExperience_translation["deDE"] = {
    ...
    ["When enabled, the addon saves and loads action bar assignments as part of profiles. When disabled, your server-side action bar assignments are left untouched."] = "Wenn aktiviert, speichert und lädt das Addon die Aktionsleisten-Belegung als Teil der Profile. Wenn deaktiviert, bleiben die serverseitigen Aktionsleisten-Belegungen unverändert.",
