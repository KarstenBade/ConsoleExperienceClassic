...
ConsoleExperience_translation["esES"] = {
    ...
    ["Manage action bars via profiles"] = "Gestionar barras de acción mediante perfiles",
    ["When enabled, the addon manages action bar assignments via profiles and automatically preserves your original action bar layout by restoring it on logout. When disabled, the addon does not modify action bar assignments."] = "Cuando está activado, el addon gestiona las asignaciones de barras de acción mediante perfiles y restaura automáticamente tu distribución original al cerrar sesión. Cuando está desactivado, el addon no modifica las asignaciones de barras de acción.",
