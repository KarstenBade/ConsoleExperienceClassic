...
ConsoleExperience_translation["esES"] = {
    ...
    ["When enabled, the addon saves and loads action bar assignments as part of profiles. When disabled, your server-side action bar assignments are left untouched."] = "Cuando está activado, el addon guarda y carga las asignaciones de barras de acción como parte de los perfiles. Cuando está desactivado, las asignaciones de barras de acción del servidor no se modifican.",
